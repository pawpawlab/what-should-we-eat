...
function StatusChip({ done }: { done: boolean }) {
  return (
    <span
      className={`rounded-bubble px-2.5 py-1 text-[12px] font-semibold ${
 ...
 */
export function PreferenceHeader({ roomId, role }: PreferenceHeaderProps) {
  ...
  return (
    <div
      className="sticky top-0 z-20 flex items-center justify-center gap-2 bg-cream/85 px-4 py-2.5 backdrop-blur"
